...
int main(){
    ...
    auxiliar->clave = 5;
    printf("MI PRUEBA Busco el elemento 5: %s\n", abb_buscar(arbol, auxiliar)==c5?"OK":"ERROR");
    ...
    auxiliar->clave = 1;
    printf("MI PRUEBA Busco el elemento 1: %s\n", abb_buscar(arbol, auxiliar)==c1?"OK":"ERROR");
    auxiliar->clave = 3;
    printf("MI PRUEBA Busco el elemento 3: %s\n", abb_buscar(arbol, auxiliar)==c3?"OK":"ERROR");
    auxiliar->clave = 5;
    printf("MI PRUEBA Busco el elemento 5: %s\n", abb_buscar(arbol, auxiliar)==c5?"OK":"ERROR");
